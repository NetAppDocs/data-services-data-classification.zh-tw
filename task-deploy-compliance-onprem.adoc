...
summary: 若要在您的網路中的 Linux 主機或具有網際網路存取權的雲端 Linux 主機上安裝 NetApp Data Classification，您需要在您的網路或雲端中手動部署該 Linux 主機。 
---
...
大多數情況下，資料分類功能安裝在單主機系統上。這與 Console 代理程式所在的虛擬機器主機不同。<<典型配置的單主機安裝,請參閱此處的步驟>>。
...
.步驟
. 從 https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/["NetApp支援站點"^]下載 Data Classification 軟體。選擇名為 *DATASENSE-INSTALLER-<version>.tar.gz* 的檔案。
