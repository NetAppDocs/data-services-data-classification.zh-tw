...
請注意，您也可以link:task-deploy-compliance-onprem.html["在可以存取網際網路的 Linux 主機上安裝資料分類"]。如果您希望使用位於本機的 NetApp Data Classification 執行個體掃描本機 ONTAP 系統，這種安裝方式可能是個不錯的選擇——但這並非必要條件。無論您選擇哪種安裝方式，軟體的功能都完全相同。
...
如果您還沒有控制台代理，請建立一個。看link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["在 AWS 中建立控制台代理"^]，link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["在 Azure 中建立控制台代理"^] ， 或者link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["在 GCP 中建立控制台代理"^]。

[role="quick-margin-para"]
你也可以link:https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["在本機安裝控制台代理"^]在您網路中的 Linux 主機上，或是在雲端的 Linux 主機上。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["二"]先決條件
[role="quick-margin-para"]
請確保您的環境能夠符合先決條件。這包括該實例的對外網際網路存取、Console agent 與 Data Classification 之間透過 443 埠的連線，以及其他要求。<<先決條件,查看完整列表>>。
...
如果您還沒有 Console 代理程式，請在您的雲端供應商中建立 Console 代理程式。請參閱 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["在 AWS 中建立控制台代理"^]或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["在 Azure 中建立控制台代理"^]，或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["在 GCP 中建立控制台代理"^]。在大多數情況下，您可能在嘗試啟動 Data Classification 之前就已設定好 Console 代理程式，因為大多數 https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["控制台功能需要控制台代理"]，但在某些情況下您需要立即設定一個。

在某些情況下，您必須使用部署在特定雲端供應商中的 Console 代理程式：
...
請注意，您也可以 https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["在本機安裝控制台代理"^]在網路或雲端的 Linux 主機上。一些計劃在本機安裝資料分類的使用者可能也會選擇在本機安裝控制台代理程式。

可能有些情況下你需要使用 https://docs.netapp.com/us-en/console-setup-admin/concept-agents.html#multiple-systems-and-agents["多個控制台代理"^]。
...
link:https://docs.netapp.com/us-en/console-setup-admin/task-install-restricted-mode.html["了解如何在政府區域部署控制台代理"^]。
...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html["AWS 文件：Amazon EC2 服務配額"^]
* link:https://docs.microsoft.com/en-us/azure/virtual-machines/linux/quotas["Azure 文件：虛擬機器 vCPU 配額"^]
* link:https://docs.cloud.google.com/docs/quotas/view-manage["Google Cloud 文件：資源配額"^]
