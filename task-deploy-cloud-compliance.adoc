...
如果您還沒有 Console 代理程式，請在雲端供應商中建立 Console 代理程式。請參閱 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["在 AWS 中建立控制台代理"^]或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["在 Azure 中建立控制台代理"^]，或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["在 GCP 中建立控制台代理"^]。在大多數情況下，您可能在嘗試啟動 Data Classification 之前就已經設定好 Console 代理程式，因為大多數 https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["控制台功能需要控制台代理"]，但在某些情況下，您需要立即設定一個。
